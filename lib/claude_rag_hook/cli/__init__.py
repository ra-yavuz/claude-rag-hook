...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="crh",
        description=(
            "claude-rag-hook command-line tool. The hook fires inside "
        ...
        epilog=(
            ...
            "See /usr/share/doc/claude-rag-hook/README.md."
        ),
    )
    ...
    rfsub.add_parser("start", help="systemctl --user start claude-rag-hook-refresher.").set_defaults(
        func=refresher_cmd.run_start
    )
    rfsub.add_parser("stop", help="systemctl --user stop claude-rag-hook-refresher.").set_defaults(
